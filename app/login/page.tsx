...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen bg-[#f9f9f9] flex items-center justify-center px-6">
      <div className="bg-white rounded-2xl shadow-sm p-10 w-full max-w-md">
        <h1 className="text-3xl font-black mb-2">Accedi</h1>
        <p className="text-gray-500 mb-8">Bentornato su <span style={{ color: "var(--accent)" }}>AkiraPrint</span></p>
  ...
  <button
    ...
    className="w-full py-3 rounded-full font-bold border hover:bg-gray-50 transition flex items-center justify-center gap-3"
  >
